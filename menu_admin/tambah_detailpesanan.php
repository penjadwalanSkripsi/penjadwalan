            ...
            <input type="text" class="form-control" id="nama" name="nama" placeholder="nama pemesan" required>
             ...
             <div class="form-group">
                        ...
                        <div class="input-group date" id="id_4">
                            <input type="number" value="" id="id_barang" name="id_barang" class="form-control" required/>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group date" id="id_4">
                            <input type="number" value="" id="id_pesanan" name="id_pesanan" class="form-control" required/>
                     ...
                     <div class="form-group">
                        ...
                        <div class="input-group date" id="id_4">
                            <input type="number" value="" id="jumlah" name="jumlah" class="form-control" required/>
